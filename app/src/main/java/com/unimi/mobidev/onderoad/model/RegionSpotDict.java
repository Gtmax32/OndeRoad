...
public class RegionSpotDict {
    ...
    static {
        ...
        DICT.put("Puglia", Arrays.asList(new SpotInfo("Bari", 41.1171432, 16.871871499999997, 0, null), new SpotInfo("Brindisi", 40.6327278, 17.941761600000063, 0, null), new SpotInfo("Capitolo", 40.9118645, 17.342013500000007, 0, null), new SpotInfo("Litoranea", 39.8427077, 18.21691899999996, 0, null), new SpotInfo("Torretta a Mare", 40.3324795, 17.4033637, 0, null), new SpotInfo("Monopoli", 40.9525166, 17.298555899999997, 0, null), new SpotInfo("Otranto", 40.1438978, 18.49116779999997, 0, null), new SpotInfo("Otranto", 40.1438978, 18.49116779999997, 0, null), new SpotInfo("Lesina Marina", 41.9129844, 15.334154799999965, 0, null), new SpotInfo("Trani", 41.2774857, 16.417833400000063, 0, null), new SpotInfo("Vieste", 41.8824764, 16.176748900000007, 0, null)));
